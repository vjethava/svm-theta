...
% Usage
%  
%  [RankedVariables,nbsvvec,Values,NbQP]=FeatSelregmarginGDrandom(x,y,c,epsilon,kernel,kerneloption,verbose,FeatSeloption)
%
%
%
...
for iterrandom=1:nbiterrandommax
    ...
    while    norm(scaling-scalingold)/norm(scaling) > thresh & iter<itermax
        ...
        for i=1:nbvar
            ...
            % ps est calcul? en fonction du scaling factor, xi est les exemples
            % donn?es % ? la variable i
            xnon2= xaux(:,i); 
            xpos=xaux(:,:);
